  ...
  <main class="container-fluid px-5 py-5">
    ...
    <section id="ooh" class="service-section mb-5">
      <div class="service-card">
        <div class="row g-0">
          ...
          <div class="col-lg-5">
            <div class="service-image" style="background-image:url('{{ asset('images/services/events.png') }}');background-size:cover;background-position:center;"></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="interior" class="service-section mb-5">
      <div class="service-card service-card-dark">
        <div class="row g-0">
          <div class="col-lg-5">
            <div class="service-image" style="background-image:url('{{ asset('images/services/interior.png') }}');background-size:cover;background-position:center;"></div>
          </div>
          <div class="col-lg-7 p-5">
    ...
    <section id="branding" class="service-section mb-5">
      <div class="service-card">
        <div class="row g-0">
          ...
          <div class="col-lg-5">
            <div class="service-image" style="background-image:url('{{ asset('images/branding.png') }}');background-size:cover;background-position:center;"></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="digital" class="service-section mb-5">
      <div class="service-card service-card-dark">
        <div class="row g-0">
          <div class="col-lg-5">
            <div class="service-image" style="background-image:url('{{ asset('images/services/digital-marketing.png') }}');background-size:cover;background-position:center;"></div>
          </div>
          <div class="col-lg-7 p-5">
    ...
    <section id="video" class="service-section mb-5">
      <div class="service-card">
        <div class="row g-0">
          ...
          <div class="col-lg-5">
            <div class="service-image" style="background-image:url('{{ asset('images/services/video.png') }}');background-size:cover;background-position:center;"></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="gifts" class="service-section mb-5">
      <div class="service-card service-card-dark">
        <div class="row g-0">
          <div class="col-lg-5">
            <div class="service-image" style="background-image:url('{{ asset('images/services/gifts.png') }}');background-size:cover;background-position:center;"></div>
          </div>
          <div class="col-lg-7 p-5">
    ...
    <section id="web" class="service-section mb-5">
      <div class="service-card service-card-dark">
        <div class="row g-0">
          <div class="col-lg-5">
            <div class="service-image" style="background-image:url('{{ asset('images/services/web.png') }}');background-size:cover;background-position:center;"></div>
          </div>
          <div class="col-lg-7 p-5">
    ...
    <section id="permits" class="service-section mb-5">
      <div class="service-card">
        <div class="row g-0">
          ...
          <div class="col-lg-5">
            <div class="service-image" style="background-image:url('{{ asset('images/services/permits.png') }}');background-size:cover;background-position:center;"></div>
          </div>
        </div>
      </div>
    </section>
