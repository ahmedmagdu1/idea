...
@section('content')
<!-- Hero -->
<div style="background: url('{{ asset('images/contact-hero.jpg') }}') center center/cover no-repeat; min-height:140px;">
    <div class="container py-4">
        <h2 class="fw-bold text-center text-white mb-1" style="text-shadow:0 2px 10px #0007;">Contact Us</h2>
        <div class="text-center text-white mb-2" style="opacity:.96;">Any question or remarks? Just write us a message!</div>
    </div>
</div>
