...
<div class="container-fluid px-4">
    ...
    <div class="dashboard-header fade-in">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-2">
                    <i class="fas fa-edit me-3"></i>Content Management Dashboard
                </h1>
                <p class="mb-0 opacity-75">
                    Manage your Blade templates, language files, and media assets
                </p>
            </div>
    ...
    <div class="row mb-4">
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stat-card fade-in" style="animation-delay: 0.1s">
                ...
                <div class="text-center">
                    <h3 class="fw-bold text-primary mb-1">{{ count($viewFiles) }}</h3>
                    <p class="text-muted mb-0">Blade Templates</p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stat-card fade-in" style="animation-delay: 0.2s">
                ...
                <div class="text-center">
                    ...
                    <p class="text-muted mb-0">Language Files</p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stat-card fade-in" style="animation-delay: 0.3s">
                ...
                <div class="text-center">
                    <h3 class="fw-bold text-warning mb-1">{{ count($imageFiles) }}</h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stat-card fade-in" style="animation-delay: 0.4s">
                ...
                <div class="text-center">
                    <h3 class="fw-bold text-info mb-1">{{ count($recentEdits) }}</h3>
                    <p class="text-muted mb-0">Recent Edits</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0">
                        ...
                        Blade Templates
                        <span class="badge bg-primary ms-2">{{ count($viewFiles) }}</span>
                    </h5>
                </div>
                <div class="col-md-6">
            ...
            <table class="table align-middle mb-0">
                ...
                @forelse($viewFiles as $index => $file)
                    <tr class="file-row fade-in" 
                        ...
                        <td class="text-end py-3">
                            <a class="btn btn-custom btn-edit btn-sm" 
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="empty-state">
                                <i class="fas fa-file-code"></i>
                                <p class="mb-0">No blade templates found</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0">
                        ...
                        Recent Images
                        <span class="badge bg-warning ms-2">{{ count($imageFiles) }}</span>
                    </h5>
                </div>
                <div class="col-md-6 text-md-end">
                    <small class="text-muted">
                        Showing {{ count(array_slice($imageFiles, 0, 12)) }} of {{ count($imageFiles) }} images
                    </small>
                </div>
            </div>
        </div>
                ...
                @if(count($imageFiles) > 12)
                    <div class="text-center mt-4">
                        <div class="alert alert-info border-0 d-inline-flex align-items-center">
                            ...
                            And {{ count($imageFiles) - 12 }} more images available in the editor
                        </div>
                    </div>
                @endif
            @else
                <div class="empty-state">
                    ...
                    <small class="text-muted">Upload images through the content editor</small>
                </div>
            @endif
        </div>
    </div>
