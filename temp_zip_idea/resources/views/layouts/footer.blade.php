                ...
                <div class="row g-3 justify-content-between">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <ul class="footer-links">
                            <li><a href="#about">{{ __('main.footer_about') }}</a></li>
                            <li><a href="#contact">{{ __('main.footer_contact') }}</a></li>
                            <li><a href="#careers">{{ __('main.footer_careers') }}</a></li>
                            <li><a href="#press">{{ __('main.footer_press') }}</a></li>
                        </ul>
                    </div>
                    <!-- Services -->
                    <div class="col-6 col-md-3">
                        ...
                        <ul class="footer-links">
                            <li><a href="#">{{ __('main.service_ooh') }}</a></li>
                            <li><a href="#">{{ __('main.service_interior') }}</a></li>
                            <li><a href="#">{{ __('main.service_branding') }}</a></li>
                            <li><a href="#">{{ __('main.service_digital') }}</a></li>
                            <li><a href="#">{{ __('main.service_video') }}</a></li>
                            <li><a href="#">{{ __('main.service_web') }}</a></li>
                            <li><a href="#">{{ __('main.service_event') }}</a></li>
                            <li><a href="#">{{ __('main.service_gifts') }}</a></li>
                            <li><a href="#">{{ __('main.service_game') }}</a></li>
                            <li><a href="#">{{ __('main.service_permits') }}</a></li>
                        </ul>
                    </div>
                    <!-- Legal -->
                    <div class="col-6 col-md-2">
                        ...
                        <ul class="footer-links">
                            <li><a href="#privacy">{{ __('main.footer_privacy') }}</a></li>
                            <li><a href="#terms">{{ __('main.footer_terms') }}</a></li>
                        </ul>
                    </div>
                    <!-- Contact us -->
