...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom" style="min-height:56px;">
...
<div class="collapse navbar-collapse justify-content-center" id="mainNavbar">
    <ul class="navbar-nav mx-auto gap-lg-3">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->is('portfolio') ? 'active' : '' }}" href="{{ url('/portfolio') }}">
                Portfolio
            </a>
        </li>
...
<!-- Language Switch -->
<div class="lang-switch ms-lg-auto ps-lg-3 d-flex align-items-center">
