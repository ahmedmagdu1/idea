...
class ContentManagementController extends Controller
{
     ...
     */
    public function getLanguageData(Request $request): JsonResponse
    {
        try {
    ...
    private function loadLanguageData(string $locale): array
    {
        ...
        foreach ($files as $file) {
            ...
            $languageData[$filename] = is_array($content) ? $content : [];
        }
    ...
    {
        // يمكن تنفيذ هذا لاحقاً بحفظ في قاعدة البيانات
        return [];
    }
}
